...
public class HomeRecord extends UpdatableRecordImpl<HomeRecord> implements Record4<String, String, Instant, Instant> {
     ...
     */
    public HomeRecord setId(String value) {
        set(0, value);
        return this;
    }
    ...
    @Override
    public HomeRecord value1(String value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public HomeRecord values(String value1, String value2, Instant value3, Instant value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public HomeRecord(String id, String name, Instant dateCreated, Instant lastUpdated) {
        super(JHome.HOME);
